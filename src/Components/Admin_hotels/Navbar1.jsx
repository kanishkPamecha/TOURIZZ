        ...
        <div className={`d-flex ${sidebarOpen ? 'toggled' : 'non'}`} id="wrapper" style={{marginTop:'-10px',position:'absolute'}}>
            <div className="bg-light border-right" id="sidebar-wrapper">
                <div className="list-group list-group-flush">
                    <a href="#" className="list-group-item list-group-item-action bg-light">Modify Hotels</a>
                    <a href="#" className="list-group-item list-group-item-action bg-light"> Modify Room</a>
